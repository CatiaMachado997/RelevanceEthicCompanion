-- Migration 009: Tool Marketplace
-- Creates tool_definitions, user_tool_connections, tool_permissions tables
-- and seeds the initial catalogue of 5 integrations + custom MCP.
-- Applied to production Supabase to enable the Composio-powered tool marketplace.
