...
app.include_router(
    weekly_review.router, prefix="/api/weekly-review", tags=["weekly-review"]
)
...
from routes.autolab import (
    router as autolab_router,
    insights_router as autolab_insights_router,
)
