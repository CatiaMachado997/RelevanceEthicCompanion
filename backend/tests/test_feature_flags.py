...
def test_rollout_assignment_is_stable(monkeypatch):
    ...
    first = rollout_variant("RAG_ROLLOUT", "user-123", percent_env="RAG_ROLLOUT_PERCENT")
    assert first == rollout_variant("RAG_ROLLOUT", "user-123", percent_env="RAG_ROLLOUT_PERCENT")
