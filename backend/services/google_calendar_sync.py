...
class GoogleCalendarSync:
    ...
    def _load_client_config(self) -> Dict[str, Any]:
        ...
        creds_path = os.path.join(os.path.dirname(__file__), '..', 'credentials', 'google_oauth.json')
    ...
    def exchange_code_for_tokens(self, authorization_code: str) -> Dict[str, str]:
        ...
        try:
            ...
            expires_at = datetime.now(timezone.utc) + timedelta(seconds=creds.expiry.timestamp() - datetime.now().timestamp())
